...
static
{
	...
	[Inline] public static VkResult Submit(this VkQueue queue, VulkanSpan<VkSubmitInfo> submits = .(), VkFence fence = null) => vkQueueSubmit(queue, submits.count, submits.ptr, fence);
	...
	[Inline] public static VkResult FlushMappedMemoryRanges(this VkDevice device, VulkanSpan<VkMappedMemoryRange> memoryRanges) => vkFlushMappedMemoryRanges(device, memoryRanges.count, memoryRanges.ptr);
	[Inline] public static VkResult InvalidateMappedMemoryRanges(this VkDevice device, VulkanSpan<VkMappedMemoryRange> memoryRanges) => vkInvalidateMappedMemoryRanges(device, memoryRanges.count, memoryRanges.ptr);
	...
	[Inline] public static VkResult BindSparse(this VkQueue queue, VulkanSpan<VkBindSparseInfo> bindInfo = .(), VkFence fence = null) => vkQueueBindSparse(queue, bindInfo.count, bindInfo.ptr, fence);
	...
	[Inline] public static VkResult ResetFences(this VkDevice device, VulkanSpan<VkFence> fences) => vkResetFences(device, fences.count, fences.ptr);
	[Inline] public static VkResult GetStatus(this VkFence fence, VkDevice device) => vkGetFenceStatus(device, fence);
	[Inline] public static VkResult WaitForFences(this VkDevice device, VulkanSpan<VkFence> fences, VkBool32 waitAll, uint64 timeout) => vkWaitForFences(device, fences.count, fences.ptr, waitAll, timeout);
	...
	[Inline] public static VkResult Merges(this VkPipelineCache dstCache, VkDevice device, VulkanSpan<VkPipelineCache> srcCaches) => vkMergePipelineCaches(device, dstCache, srcCaches.count, srcCaches.ptr);
	...
	[Inline] public static VkResult CreateGraphicsPipelines(this VkPipelineCache pipelineCache, VkDevice device, VulkanSpan<VkGraphicsPipelineCreateInfo> createInfos, VkAllocationCallbacks* pAllocator, out VkPipeline pPipelines) => vkCreateGraphicsPipelines(device, pipelineCache, createInfos.count, createInfos.ptr, pAllocator, out pPipelines);
	[Inline] public static VkResult CreateComputePipelines(this VkPipelineCache pipelineCache, VkDevice device, VulkanSpan<VkComputePipelineCreateInfo> createInfos, VkAllocationCallbacks* pAllocator, out VkPipeline pPipelines) => vkCreateComputePipelines(device, pipelineCache, createInfos.count, createInfos.ptr, pAllocator, out pPipelines);
	...
	[Inline] public static VkResult FreeDescriptorSets(this VkDescriptorPool descriptorPool, VkDevice device, VulkanSpan<VkDescriptorSet> descriptorSets) => vkFreeDescriptorSets(device, descriptorPool, descriptorSets.count, descriptorSets.ptr);
	[Inline] public static void UpdateDescriptorSets(this VkDevice device, VulkanSpan<VkWriteDescriptorSet> descriptorWrites = .(), VulkanSpan<VkCopyDescriptorSet> descriptorCopies = .()) => vkUpdateDescriptorSets(device, descriptorWrites.count, descriptorWrites.ptr, descriptorCopies.count, descriptorCopies.ptr);
	...
	[Inline] public static void FreeCommandBuffers(this VkCommandPool commandPool, VkDevice device, VulkanSpan<VkCommandBuffer> commandBuffers) => vkFreeCommandBuffers(device, commandPool, commandBuffers.count, commandBuffers.ptr);
	...
	[Inline] public static void CmdSetViewport(this VkCommandBuffer commandBuffer, uint32 firstViewport, VulkanSpan<VkViewport> viewports) => vkCmdSetViewport(commandBuffer, firstViewport, viewports.count, viewports.ptr);
	[Inline] public static void CmdSetScissor(this VkCommandBuffer commandBuffer, uint32 firstScissor, VulkanSpan<VkRect2D> scissors) => vkCmdSetScissor(commandBuffer, firstScissor, scissors.count, scissors.ptr);
	...
	[Inline] public static void CmdBindDescriptorSets(this VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32 firstSet, VulkanSpan<VkDescriptorSet> descriptorSets, VulkanSpan<uint32> dynamicOffsets = .()) => vkCmdBindDescriptorSets(commandBuffer, pipelineBindPoint, layout, firstSet, descriptorSets.count, descriptorSets.ptr, dynamicOffsets.count, dynamicOffsets.ptr);
	...
	[Inline] public static void CmdBindVertexBuffers(this VkCommandBuffer commandBuffer, uint32 firstBinding, VulkanDuoSpan<VkBuffer, VkDeviceSize> buffers_offsets) => vkCmdBindVertexBuffers(commandBuffer, firstBinding, buffers_offsets.count, buffers_offsets.ptr1, buffers_offsets.ptr2);
	...
	[Inline] public static void CmdDrawMultiEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkMultiDrawInfoEXT> vertexInfo, uint32 instanceCount, uint32 firstInstance, uint32 stride) => vkCmdDrawMultiEXT(commandBuffer, vertexInfo.count, vertexInfo.ptr, instanceCount, firstInstance, stride);
	[Inline] public static void CmdDrawMultiIndexedEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkMultiDrawIndexedInfoEXT> indexInfo, uint32 instanceCount, uint32 firstInstance, uint32 stride, int32* pVertexOffset = null) => vkCmdDrawMultiIndexedEXT(commandBuffer, indexInfo.count, indexInfo.ptr, instanceCount, firstInstance, stride, pVertexOffset);
	...
	[Inline] public static void CmdCopyBuffer(this VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkBuffer dstBuffer, VulkanSpan<VkBufferCopy> regions) => vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, regions.count, regions.ptr);
	[Inline] public static void CmdCopyImage(this VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, VulkanSpan<VkImageCopy> regions) => vkCmdCopyImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regions.count, regions.ptr);
	[Inline] public static void CmdBlitImage(this VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, VulkanSpan<VkImageBlit> regions, VkFilter filter) => vkCmdBlitImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regions.count, regions.ptr, filter);
	[Inline] public static void CmdCopyBufferToImage(this VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkImage dstImage, VkImageLayout dstImageLayout, VulkanSpan<VkBufferImageCopy> regions) => vkCmdCopyBufferToImage(commandBuffer, srcBuffer, dstImage, dstImageLayout, regions.count, regions.ptr);
	[Inline] public static void CmdCopyImageToBuffer(this VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkBuffer dstBuffer, VulkanSpan<VkBufferImageCopy> regions) => vkCmdCopyImageToBuffer(commandBuffer, srcImage, srcImageLayout, dstBuffer, regions.count, regions.ptr);
	...
	[Inline] public static void CmdClearColorImage(this VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, VkClearColorValue* pColor, VulkanSpan<VkImageSubresourceRange> ranges) => vkCmdClearColorImage(commandBuffer, image, imageLayout, pColor, ranges.count, ranges.ptr);
	[Inline] public static void CmdClearDepthStencilImage(this VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, VkClearDepthStencilValue* pDepthStencil, VulkanSpan<VkImageSubresourceRange> ranges) => vkCmdClearDepthStencilImage(commandBuffer, image, imageLayout, pDepthStencil, ranges.count, ranges.ptr);
	[Inline] public static void CmdClearAttachments(this VkCommandBuffer commandBuffer, VulkanSpan<VkClearAttachment> attachments, VulkanSpan<VkClearRect> rects) => vkCmdClearAttachments(commandBuffer, attachments.count, attachments.ptr, rects.count, rects.ptr);
	[Inline] public static void CmdResolveImage(this VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, VulkanSpan<VkImageResolve> regions) => vkCmdResolveImage(commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regions.count, regions.ptr);
	...
	[Inline] public static void CmdWaitEvents(this VkCommandBuffer commandBuffer, VulkanSpan<VkEvent> events, VkPipelineStageFlags srcStageMask = 0, VkPipelineStageFlags dstStageMask = 0, VulkanSpan<VkMemoryBarrier> memoryBarriers = .(), VulkanSpan<VkBufferMemoryBarrier> bufferMemoryBarriers = .(), VulkanSpan<VkImageMemoryBarrier> imageMemoryBarriers = .()) => vkCmdWaitEvents(commandBuffer, events.count, events.ptr, srcStageMask, dstStageMask, memoryBarriers.count, memoryBarriers.ptr, bufferMemoryBarriers.count, bufferMemoryBarriers.ptr, imageMemoryBarriers.count, imageMemoryBarriers.ptr);
	[Inline] public static void CmdPipelineBarrier(this VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask = 0, VkPipelineStageFlags dstStageMask = 0, VkDependencyFlags dependencyFlags = 0, VulkanSpan<VkMemoryBarrier> memoryBarriers = .(), VulkanSpan<VkBufferMemoryBarrier> bufferMemoryBarriers = .(), VulkanSpan<VkImageMemoryBarrier> imageMemoryBarriers = .()) => vkCmdPipelineBarrier(commandBuffer, srcStageMask, dstStageMask, dependencyFlags, memoryBarriers.count, memoryBarriers.ptr, bufferMemoryBarriers.count, bufferMemoryBarriers.ptr, imageMemoryBarriers.count, imageMemoryBarriers.ptr);
	...
	[Inline] public static void CmdPushConstants(this VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlags stageFlags, uint32 offset, uint32 size, void* pValues) => vkCmdPushConstants(commandBuffer, layout, stageFlags, offset, size, pValues);
	...
	[Inline] public static VkResult CreateSharedSwapchainsKHR(this VkDevice device, VulkanSpan<VkSwapchainCreateInfoKHR> createInfos, VkAllocationCallbacks* pAllocator, out VkSwapchainKHR pSwapchains) => vkCreateSharedSwapchainsKHR(device, createInfos.count, createInfos.ptr, pAllocator, out pSwapchains);
	...
	[Inline] public static void UpdatePipelineEXT(this VkIndirectExecutionSetEXT indirectExecutionSet, VkDevice device, VulkanSpan<VkWriteIndirectExecutionSetPipelineEXT> executionSetWrites) => vkUpdateIndirectExecutionSetPipelineEXT(device, indirectExecutionSet, executionSetWrites.count, executionSetWrites.ptr);
	[Inline] public static void UpdateShaderEXT(this VkIndirectExecutionSetEXT indirectExecutionSet, VkDevice device, VulkanSpan<VkWriteIndirectExecutionSetShaderEXT> executionSetWrites) => vkUpdateIndirectExecutionSetShaderEXT(device, indirectExecutionSet, executionSetWrites.count, executionSetWrites.ptr);
	...
	[Inline] public static VkResult BindBufferMemory2(this VkDevice device, VulkanSpan<VkBindBufferMemoryInfo> bindInfos) => vkBindBufferMemory2(device, bindInfos.count, bindInfos.ptr);
	[Inline] public static VkResult BindImageMemory2(this VkDevice device, VulkanSpan<VkBindImageMemoryInfo> bindInfos) => vkBindImageMemory2(device, bindInfos.count, bindInfos.ptr);
	...
	[Inline] public static void SetHdrMetadataEXT(this VkDevice device, VulkanDuoSpan<VkSwapchainKHR, VkHdrMetadataEXT> swapchains_metadata) => vkSetHdrMetadataEXT(device, swapchains_metadata.count, swapchains_metadata.ptr1, swapchains_metadata.ptr2);
	...
	[Inline] public static VkResult MergesEXT(this VkValidationCacheEXT dstCache, VkDevice device, VulkanSpan<VkValidationCacheEXT> srcCaches) => vkMergeValidationCachesEXT(device, dstCache, srcCaches.count, srcCaches.ptr);
	...
	[Inline] public static VkResult GetCalibratedTimestampsKHR(this VkDevice device, VulkanDuoSpan<VkCalibratedTimestampInfoKHR, uint64> timestampInfos_timestamps, out uint64 pMaxDeviation) => vkGetCalibratedTimestampsKHR(device, timestampInfos_timestamps.count, timestampInfos_timestamps.ptr1, timestampInfos_timestamps.ptr2, out pMaxDeviation);
	...
	[Inline] public static void CmdBindTransformFeedbackBuffersEXT(this VkCommandBuffer commandBuffer, uint32 firstBinding, VulkanTrioSpan<VkBuffer, VkDeviceSize, VkDeviceSize> buffers_offsets_sizes = .()) => vkCmdBindTransformFeedbackBuffersEXT(commandBuffer, firstBinding, buffers_offsets_sizes.count, buffers_offsets_sizes.ptr1, buffers_offsets_sizes.ptr2, buffers_offsets_sizes.ptr3);
	[Inline] public static void CmdBeginTransformFeedbackEXT(this VkCommandBuffer commandBuffer, uint32 firstCounterBuffer, VulkanDuoSpan<VkBuffer, VkDeviceSize> counterBuffers_counterBufferOffsets = .()) => vkCmdBeginTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBuffers_counterBufferOffsets.count, counterBuffers_counterBufferOffsets.ptr1, counterBuffers_counterBufferOffsets.ptr2);
	[Inline] public static void CmdEndTransformFeedbackEXT(this VkCommandBuffer commandBuffer, uint32 firstCounterBuffer, VulkanDuoSpan<VkBuffer, VkDeviceSize> counterBuffers_counterBufferOffsets = .()) => vkCmdEndTransformFeedbackEXT(commandBuffer, firstCounterBuffer, counterBuffers_counterBufferOffsets.count, counterBuffers_counterBufferOffsets.ptr1, counterBuffers_counterBufferOffsets.ptr2);
	...
	[Inline] public static void CmdSetExclusiveScissorNV(this VkCommandBuffer commandBuffer, uint32 firstExclusiveScissor, VulkanSpan<VkRect2D> exclusiveScissors) => vkCmdSetExclusiveScissorNV(commandBuffer, firstExclusiveScissor, exclusiveScissors.count, exclusiveScissors.ptr);
	[Inline] public static void CmdSetExclusiveScissorEnableNV(this VkCommandBuffer commandBuffer, uint32 firstExclusiveScissor, VulkanSpan<VkBool32> exclusiveScissorEnables) => vkCmdSetExclusiveScissorEnableNV(commandBuffer, firstExclusiveScissor, exclusiveScissorEnables.count, exclusiveScissorEnables.ptr);
	...
	[Inline] public static void CmdSetViewportShadingRatePaletteNV(this VkCommandBuffer commandBuffer, uint32 firstViewport, VulkanSpan<VkShadingRatePaletteNV> shadingRatePalettes) => vkCmdSetViewportShadingRatePaletteNV(commandBuffer, firstViewport, shadingRatePalettes.count, shadingRatePalettes.ptr);
	[Inline] public static void CmdSetCoarseSampleOrderNV(this VkCommandBuffer commandBuffer, VkCoarseSampleOrderTypeNV sampleOrderType, VulkanSpan<VkCoarseSampleOrderCustomNV> customSampleOrders = .()) => vkCmdSetCoarseSampleOrderNV(commandBuffer, sampleOrderType, customSampleOrders.count, customSampleOrders.ptr);
	...
	[Inline] public static VkResult BindAccelerationStructureMemoryNV(this VkDevice device, VulkanSpan<VkBindAccelerationStructureMemoryInfoNV> bindInfos) => vkBindAccelerationStructureMemoryNV(device, bindInfos.count, bindInfos.ptr);
	...
	[Inline] public static void CmdWriteAccelerationStructuresPropertiesKHR(this VkCommandBuffer commandBuffer, VulkanSpan<VkAccelerationStructureKHR> accelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32 firstQuery) => vkCmdWriteAccelerationStructuresPropertiesKHR(commandBuffer, accelerationStructures.count, accelerationStructures.ptr, queryType, queryPool, firstQuery);
	[Inline] public static void CmdWriteAccelerationStructuresPropertiesNV(this VkCommandBuffer commandBuffer, VulkanSpan<VkAccelerationStructureNV> accelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32 firstQuery) => vkCmdWriteAccelerationStructuresPropertiesNV(commandBuffer, accelerationStructures.count, accelerationStructures.ptr, queryType, queryPool, firstQuery);
	...
	[Inline] public static VkResult WriteAccelerationStructuresPropertiesKHR(this VkDevice device, VulkanSpan<VkAccelerationStructureKHR> accelerationStructures, VkQueryType queryType, c_size dataSize, out void pData, c_size stride) => vkWriteAccelerationStructuresPropertiesKHR(device, accelerationStructures.count, accelerationStructures.ptr, queryType, dataSize, out pData, stride);
	...
	[Inline] public static VkResult CreateRayTracingPipelinesNV(this VkPipelineCache pipelineCache, VkDevice device, VulkanSpan<VkRayTracingPipelineCreateInfoNV> createInfos, VkAllocationCallbacks* pAllocator, out VkPipeline pPipelines) => vkCreateRayTracingPipelinesNV(device, pipelineCache, createInfos.count, createInfos.ptr, pAllocator, out pPipelines);
	[Inline] public static VkResult CreateRayTracingPipelinesKHR(this VkDeferredOperationKHR deferredOperation, VkDevice device, VkPipelineCache pipelineCache, VulkanSpan<VkRayTracingPipelineCreateInfoKHR> createInfos, VkAllocationCallbacks* pAllocator, out VkPipeline pPipelines) => vkCreateRayTracingPipelinesKHR(device, deferredOperation, pipelineCache, createInfos.count, createInfos.ptr, pAllocator, out pPipelines);
	...
	[Inline] public static void CmdBuildAccelerationStructuresKHR(this VkCommandBuffer commandBuffer, VulkanDuoSpan<VkAccelerationStructureBuildGeometryInfoKHR, VkAccelerationStructureBuildRangeInfoKHR> infos_buildRangeInfos) => vkCmdBuildAccelerationStructuresKHR(commandBuffer, infos_buildRangeInfos.count, infos_buildRangeInfos.ptr1, infos_buildRangeInfos.ptr2);
	[Inline] public static void CmdBuildAccelerationStructuresIndirectKHR(this VkCommandBuffer commandBuffer, VulkanQuadSpan<VkAccelerationStructureBuildGeometryInfoKHR, VkDeviceAddress, uint32, uint32> infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts) => vkCmdBuildAccelerationStructuresIndirectKHR(commandBuffer, infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts.count, infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts.ptr1, infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts.ptr2, infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts.ptr3, infos_indirectDeviceAddresses_indirectStrides_maxPrimitiveCounts.ptr4);
	[Inline] public static VkResult BuildAccelerationStructuresKHR(this VkDeferredOperationKHR deferredOperation, VkDevice device, VulkanDuoSpan<VkAccelerationStructureBuildGeometryInfoKHR, VkAccelerationStructureBuildRangeInfoKHR> infos_buildRangeInfos) => vkBuildAccelerationStructuresKHR(device, deferredOperation, infos_buildRangeInfos.count, infos_buildRangeInfos.ptr1, infos_buildRangeInfos.ptr2);
	...
	[Inline] public static void CmdSetViewportWithCount(this VkCommandBuffer commandBuffer, VulkanSpan<VkViewport> viewports) => vkCmdSetViewportWithCount(commandBuffer, viewports.count, viewports.ptr);
	[Inline] public static void CmdSetScissorWithCount(this VkCommandBuffer commandBuffer, VulkanSpan<VkRect2D> scissors) => vkCmdSetScissorWithCount(commandBuffer, scissors.count, scissors.ptr);
	...
	[Inline] public static void CmdBindVertexBuffers2(this VkCommandBuffer commandBuffer, uint32 firstBinding, VulkanQuadSpan<VkBuffer, VkDeviceSize, VkDeviceSize, VkDeviceSize> buffers_offsets_sizes_strides = .()) => vkCmdBindVertexBuffers2(commandBuffer, firstBinding, buffers_offsets_sizes_strides.count, buffers_offsets_sizes_strides.ptr1, buffers_offsets_sizes_strides.ptr2, buffers_offsets_sizes_strides.ptr3, buffers_offsets_sizes_strides.ptr4);
	...
	[Inline] public static void CmdSetColorBlendEnableEXT(this VkCommandBuffer commandBuffer, uint32 firstAttachment, VulkanSpan<VkBool32> colorBlendEnables) => vkCmdSetColorBlendEnableEXT(commandBuffer, firstAttachment, colorBlendEnables.count, colorBlendEnables.ptr);
	[Inline] public static void CmdSetColorBlendEquationEXT(this VkCommandBuffer commandBuffer, uint32 firstAttachment, VulkanSpan<VkColorBlendEquationEXT> colorBlendEquations) => vkCmdSetColorBlendEquationEXT(commandBuffer, firstAttachment, colorBlendEquations.count, colorBlendEquations.ptr);
	[Inline] public static void CmdSetColorWriteMaskEXT(this VkCommandBuffer commandBuffer, uint32 firstAttachment, VulkanSpan<VkColorComponentFlags> colorWriteMasks) => vkCmdSetColorWriteMaskEXT(commandBuffer, firstAttachment, colorWriteMasks.count, colorWriteMasks.ptr);
	...
	[Inline] public static void CmdSetColorBlendAdvancedEXT(this VkCommandBuffer commandBuffer, uint32 firstAttachment, VulkanSpan<VkColorBlendAdvancedEXT> colorBlendAdvanced) => vkCmdSetColorBlendAdvancedEXT(commandBuffer, firstAttachment, colorBlendAdvanced.count, colorBlendAdvanced.ptr);
	...
	[Inline] public static void CmdSetViewportSwizzleNV(this VkCommandBuffer commandBuffer, uint32 firstViewport, VulkanSpan<VkViewportSwizzleNV> viewportSwizzles) => vkCmdSetViewportSwizzleNV(commandBuffer, firstViewport, viewportSwizzles.count, viewportSwizzles.ptr);
	...
	[Inline] public static void CmdSetCoverageModulationTableNV(this VkCommandBuffer commandBuffer, VulkanSpan<float> coverageModulationTable) => vkCmdSetCoverageModulationTableNV(commandBuffer, coverageModulationTable.count, coverageModulationTable.ptr);
	...
	[Inline] public static void CmdSetVertexInputEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkVertexInputBindingDescription2EXT> vertexBindingDescriptions = .(), VulkanSpan<VkVertexInputAttributeDescription2EXT> vertexAttributeDescriptions = .()) => vkCmdSetVertexInputEXT(commandBuffer, vertexBindingDescriptions.count, vertexBindingDescriptions.ptr, vertexAttributeDescriptions.count, vertexAttributeDescriptions.ptr);
	[Inline] public static void CmdSetColorWriteEnableEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkBool32> colorWriteEnables) => vkCmdSetColorWriteEnableEXT(commandBuffer, colorWriteEnables.count, colorWriteEnables.ptr);
	...
	[Inline] public static void CmdWaitEvents2(this VkCommandBuffer commandBuffer, VulkanDuoSpan<VkEvent, VkDependencyInfo> events_dependencyInfos) => vkCmdWaitEvents2(commandBuffer, events_dependencyInfos.count, events_dependencyInfos.ptr1, events_dependencyInfos.ptr2);
	...
	[Inline] public static VkResult Submit2(this VkQueue queue, VulkanSpan<VkSubmitInfo2> submits = .(), VkFence fence = null) => vkQueueSubmit2(queue, submits.count, submits.ptr, fence);
	...
	[Inline] public static VkResult TransitionImageLayout(this VkDevice device, VulkanSpan<VkHostImageLayoutTransitionInfo> transitions) => vkTransitionImageLayout(device, transitions.count, transitions.ptr);
	...
	[Inline] public static VkResult BindMemoryKHR(this VkVideoSessionKHR videoSession, VkDevice device, VulkanSpan<VkBindVideoSessionMemoryInfoKHR> bindSessionMemoryInfos) => vkBindVideoSessionMemoryKHR(device, videoSession, bindSessionMemoryInfos.count, bindSessionMemoryInfos.ptr);
	...
	[Inline] public static void CmdBindDescriptorBuffersEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkDescriptorBufferBindingInfoEXT> bindingInfos) => vkCmdBindDescriptorBuffersEXT(commandBuffer, bindingInfos.count, bindingInfos.ptr);
	[Inline] public static void CmdSetDescriptorBufferOffsetsEXT(this VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32 firstSet, VulkanDuoSpan<uint32, VkDeviceSize> bufferIndices_offsets) => vkCmdSetDescriptorBufferOffsetsEXT(commandBuffer, pipelineBindPoint, layout, firstSet, bufferIndices_offsets.count, bufferIndices_offsets.ptr1, bufferIndices_offsets.ptr2);
	...
	[Inline] public static void CmdBuildMicromapsEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkMicromapBuildInfoEXT> infos) => vkCmdBuildMicromapsEXT(commandBuffer, infos.count, infos.ptr);
	[Inline] public static VkResult BuildMicromapsEXT(this VkDeferredOperationKHR deferredOperation, VkDevice device, VulkanSpan<VkMicromapBuildInfoEXT> infos) => vkBuildMicromapsEXT(device, deferredOperation, infos.count, infos.ptr);
	...
	[Inline] public static void CmdWriteMicromapsPropertiesEXT(this VkCommandBuffer commandBuffer, VulkanSpan<VkMicromapEXT> micromaps, VkQueryType queryType, VkQueryPool queryPool, uint32 firstQuery) => vkCmdWriteMicromapsPropertiesEXT(commandBuffer, micromaps.count, micromaps.ptr, queryType, queryPool, firstQuery);
	[Inline] public static VkResult WriteMicromapsPropertiesEXT(this VkDevice device, VulkanSpan<VkMicromapEXT> micromaps, VkQueryType queryType, c_size dataSize, out void pData, c_size stride) => vkWriteMicromapsPropertiesEXT(device, micromaps.count, micromaps.ptr, queryType, dataSize, out pData, stride);
	...
	[Inline] public static VkResult CreateShadersEXT(this VkDevice device, VulkanSpan<VkShaderCreateInfoEXT> createInfos, VkAllocationCallbacks* pAllocator, out VkShaderEXT pShaders) => vkCreateShadersEXT(device, createInfos.count, createInfos.ptr, pAllocator, out pShaders);
